...
import { getUserActivity, updateUserProfile } from "@/src/features/users/actions";
import type { User as UserType, BorrowRequest } from "@/src/features/users/types";
  ...
  if (authLoading || !user) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-lg font-medium text-gray-500">Cargando perfil...</p>
      </div>
    );
  }
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <Badge className="bg-blue-50 text-blue-600 border-none font-bold text-[10px] tracking-widest px-2 uppercase">
                    {(user as unknown as UserType).role}
                  </Badge>
